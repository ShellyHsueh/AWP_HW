        ...
        <div class="row">
          ...
          <form class="col-12 m-2" id="form-search-url">
            <div class="form-group">
              <label for="url">Please enter a YouTube video/playlist URL, which is enabled for subtitles community contribution:</label>
              <input type="text" class="form-control" id="url">
              <p class="small text-muted">(E.g. https://www.youtube.com/watch?v=6R7ghtN8AWs&list=PLSEFni51m3VLDT975tkxkn0TUWLExZHCu)</p>
            </div>
